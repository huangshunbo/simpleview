 ...
 *
 * <p>When you implement a VerticalPagerAdapter, you must override the following methods
 * at minimum:</p>
 * <ul>
 ...
 * </ul>
 *
 * <p>VerticalPagerAdapter is more general than the adapters used for
 ...
 * steps taken during an update. A VerticalPagerAdapter may implement a form of View
 ...
 * independent of its position in the adapter. A call to the VerticalPagerAdapter method
 ...
 *
 * <p>A very simple VerticalPagerAdapter may choose to use the page Views themselves
 ...
 *
 * <p>VerticalPagerAdapter supports data set changes. Data set changes must occur on the
...
public abstract class VerticalPagerAdapter {
     ...
     * required for a VerticalPagerAdapter to function properly.
     *
