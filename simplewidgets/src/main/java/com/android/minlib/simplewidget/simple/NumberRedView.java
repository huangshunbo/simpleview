...
/**
 * @author: huangshunbo
 * @Filename: NumberRedView
 * @Description: 数字角标
 * @Copyright: Copyright (c) 2017 Tuandai Inc. All rights reserved.
 * @date: 2018/5/15 10:58
 */
public class NumberRedView extends View {

    private int mBgColor = Color.RED;
    private int mFontSize = dip2px(10);
    private final int MIN_EFFECTIVE_SIZE = dip2px(12);
    private final int MINI_RADUIS = dip2px(4);
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.NumberRedView_dot_color) {
                ...
                mFontSize = a.getDimensionPixelSize(attr, dip2px(10));
